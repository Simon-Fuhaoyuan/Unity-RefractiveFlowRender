...
public class Calibrator : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        else if (calibrationCounter >= 1 && calibrationCounter <= 18)
        {
            if (!switch_)
            {
                Material graycode = Resources.Load(materialFormat + calibrationCounter.ToString(), typeof(Material)) as Material;
